...
# -*- coding: utf-8 -*-
#
# Summit documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'Summit.tex', 'Summit Documentation',
   'Greg Gullett', 'manual'),
]
...
man_pages = [
    (master_doc, 'summit', 'Summit Documentation',
     [author], 1)
]
